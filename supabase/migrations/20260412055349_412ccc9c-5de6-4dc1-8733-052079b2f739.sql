-- Allow juridico users to delete documents (needed for edit flow)
CREATE POLICY "Juridico can delete documents"
ON public.documents
FOR DELETE
TO authenticated
USING (is_juridico());
...
-- Recreate duplicate check functions as SECURITY DEFINER
